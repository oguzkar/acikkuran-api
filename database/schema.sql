...
-- DROP TABLE IF EXISTS acikkuran_user_footnotes CASCADE;
-- DROP TABLE IF EXISTS acikkuran_user_translations CASCADE;
-- DROP TABLE IF EXISTS acikkuran_users CASCADE;
-- DROP TABLE IF EXISTS acikkuran_footnotes CASCADE;
-- DROP TABLE IF EXISTS acikkuran_translations CASCADE;
-- DROP TABLE IF EXISTS acikkuran_verseparts CASCADE;
-- DROP TABLE IF EXISTS acikkuran_rootdiffs CASCADE;
-- DROP TABLE IF EXISTS acikkuran_roots CASCADE;
-- DROP TABLE IF EXISTS acikkuran_rootchars CASCADE;
-- DROP TABLE IF EXISTS acikkuran_verses CASCADE;
-- DROP TABLE IF EXISTS acikkuran_surahs CASCADE;
-- DROP TABLE IF EXISTS acikkuran_authors CASCADE;

-- ============================================
-- Core Tables (for crawled data)
-- ============================================
